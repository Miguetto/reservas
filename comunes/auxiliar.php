...
function conectar()
{
    $pdo = new PDO('pgsql:host=localhost;dbname=reservas', 'reservas', 'reservas');
...
function existe($reservas, $dia, $hora)
{
    foreach ($reservas as $reserva) {
        if ($reserva['fecha'] == $dia && $reserva['hora'] == $hora) {
            return $reserva['usuario_id'];
        }
    }
    return false;
}